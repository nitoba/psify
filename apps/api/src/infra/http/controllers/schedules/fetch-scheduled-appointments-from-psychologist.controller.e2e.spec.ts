...
describe('Fetch Scheduled Appointments from Psychologists (E2E)', () => {
  ...
  test('[GET] /schedules/psychologists/appointments', async () => {
    ...
    const response = await request(app.getHttpServer())
      .get(`/schedules/psychologists/appointments`)
