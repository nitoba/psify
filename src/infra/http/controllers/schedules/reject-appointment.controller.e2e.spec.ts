...
describe('Reject Appointment Controller (E2E)', () => {
  ...
  test('[PUT] /schedules/appointments/:appointmentId/reject', async () => {
    ...
    const response = await request(app.getHttpServer())
      .put(`/schedules/appointments/${appointmentId}/reject`)
    ...
    expect(appointmentOnDbAfterApprove?.status).toBe('rejected')
  })
})
