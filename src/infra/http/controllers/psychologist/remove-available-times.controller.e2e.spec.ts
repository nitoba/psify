...
describe('Remove Available Times To Psychologists (E2E)', () => {
  ...
  test('[DELETE] /psychologists/available-times/:availableTimeId', async () => {
    ...
    const response = await request(app.getHttpServer())
      .delete(`/psychologists/available-times/${availableTimeOnDb.id}`)
    ...
    expect(availableTime).toBeUndefined()
  })
})
